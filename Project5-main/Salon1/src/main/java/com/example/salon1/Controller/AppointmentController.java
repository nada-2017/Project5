...
public class AppointmentController {
    ...
    public ResponseEntity getAppointmentByDay(@PathVariable Integer month){
        return ResponseEntity.status(200).body(appointmentService.getAppointmentByMonth(month));
    }
    ...
    public ResponseEntity  assignAppointmentToService(@PathVariable Integer appointment_id, @PathVariable Integer serv_id) {
        ...
        return ResponseEntity.status(200).body("Assignment Done");
    }
}
